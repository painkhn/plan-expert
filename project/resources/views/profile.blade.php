...
@section('content')
    ...
    <main class="my-10 px-10">
        <div class="max-w-6xl w-full h-auto p-10 bg-white rounded-lg border border-purple-300 mx-auto my-0">
            ...
            <hr class="mb-10">
            <form class="flex items-center mb-5 gap-2" method="POST" action="{{ route('profile.search') }}">
                @csrf
            ...
            @if ($participant && $participant->id != Auth::id())
                <div class="user-line">
                    <div
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <form class="relative bg-white rounded-lg shadow dark:bg-gray-700" method="POST"
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                ...
                                <input type="text" name="user_id" value="{{ $participant->id }}" class="hidden">
                            </div>
                            <!-- Modal footer -->
                            <div
